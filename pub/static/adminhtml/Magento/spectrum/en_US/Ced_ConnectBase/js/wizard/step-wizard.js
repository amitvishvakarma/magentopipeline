...
define([
    ...
    'mage/translate'
], function (uiRegistry, Component, $, _, ko, uiModal) {
    'use strict';
    ...
    Wizard = function (steps, modalClass) {
         ...
         */
        this.openSystemRequirementModal = function () {
            let options = {
                type: 'popup',
                responsive: true,
                innerScroll: true,
                title: 'System Requirement',
                modalClass: 'system_requirement-modal',
                buttons: [{
                    text: $.mage.__('Continue'),
                }]
            };

            uiModal(options, $('#system_requirement-modal'));
            $("#system_requirement-modal").modal('openModal');
        }
        ...
        this._next = function (newIndex) {
            ...
            var readyToRender = this.getStep().readyToRender();
            ...
            readyToRender = this.getStep().readyToRender();
            if (readyToRender == true) {
        ...
        this._prev = function (newIndex) {
            newIndex = _.isNumber(newIndex) ? newIndex : this.index - 1;
            this.getStep(newIndex).preBack(this);
    ...
    return Component.extend({
        ...
        initElement: function (step) {
            ...
            if (this.wizard == undefined && this.steps.length > 2) {
                this.open();
                this.next();
            }
        },
