...
var config = {
    config: {
        mixins: {
            'mage/validation': {
                'Magento_AdobeIoEventsClient/js/validation-mixin': true
            }
        }
    }
};
...
var config = {
    map: {
        '*': {
            tinyMCEModal: 'Magento_CatalogStaging/js/tinyMCE/modal'
        }
    }
};
...
var config = {
    map: {
        '*': {
            validateCredentials: 'Magento_QuickCheckout/js/validate-credentials',
            configureCallbackUrl: 'Magento_QuickCheckout/js/configure-callback-url'
        }
    }
};
...
var config = {
    map: {
        '*': {
            lineProgressbar: 'Ced_ConnectBase/js/line-progressbar/jquery.lineProgressbar',
            directoryRegionUpdater: 'Ced_ConnectBase/js/address/region-updater',
            vkbeautify: 'Ced_ConnectBase/js/vkbeautify.0.99.00.beta',
            highlight: 'Ced_ConnectBase/js/highlight/highlight.pack',
            j2t: 'Ced_ConnectBase/js/json-to-table'
        }
    },
    config: {
        mixins: {
            'Magento_Ui/js/grid/provider': {
                'Ced_ConnectBase/js/grid/provider-mixin': true
            }
        }
    }
};
