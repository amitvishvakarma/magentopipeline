...
class Interceptor extends \Magento\Staging\Model\Entity\Upcoming\SearchResult implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\App\RequestInterface $request, \Magento\Staging\Model\VersionManager $versionManager, $entityRequestName, $entityTable, $entityColumn, array $entityFieldsToSelect = [], ?string $entityStoreTable = null, ?string $entityStoreColumn = null, ?string $eventPrefix = null, ?string $eventObject = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $request, $versionManager, $entityRequestName, $entityTable, $entityColumn, $entityFieldsToSelect, $entityStoreTable, $entityStoreColumn, $eventPrefix, $eventObject);
    }
