<?php
namespace Magento\Banner\Model\ResourceModel\Catalogrule\Collection;

/**
 * Interceptor class for @see \Magento\Banner\Model\ResourceModel\Catalogrule\Collection
 */
class Interceptor extends \Magento\Banner\Model\ResourceModel\Catalogrule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addWebsiteCustomerGroupFilter');
        return $pluginInfo ? $this->___callPlugins('addWebsiteCustomerGroupFilter', func_get_args(), $pluginInfo) : parent::addWebsiteCustomerGroupFilter($websiteId, $customerGroupId);
    }
