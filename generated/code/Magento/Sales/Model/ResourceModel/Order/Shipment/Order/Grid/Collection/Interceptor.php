<?php
namespace Magento\Sales\Model\ResourceModel\Order\Shipment\Order\Grid\Collection;

/**
 * Interceptor class for @see \Magento\Sales\Model\ResourceModel\Order\Shipment\Order\Grid\Collection
 */
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Shipment\Order\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'sales_shipment_grid', $resourceModel = 'Magento\\Sales\\Model\\ResourceModel\\Order\\Shipment')
    {
        $this->___init();
