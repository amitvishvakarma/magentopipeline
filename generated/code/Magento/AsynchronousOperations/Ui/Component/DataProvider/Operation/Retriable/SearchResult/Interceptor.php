<?php
namespace Magento\AsynchronousOperations\Ui\Component\DataProvider\Operation\Retriable\SearchResult;

/**
 * Interceptor class for @see \Magento\AsynchronousOperations\Ui\Component\DataProvider\Operation\Retriable\SearchResult
 */
class Interceptor extends \Magento\AsynchronousOperations\Ui\Component\DataProvider\Operation\Retriable\SearchResult implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\AsynchronousOperations\Ui\Component\DataProvider\Bulk\IdentifierResolver $identifierResolver, $mainTable = 'magento_operation', $resourceModel = null, $identifierName = 'id')
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $identifierResolver, $mainTable, $resourceModel, $identifierName);
    }
