...
class Interceptor extends \Magento\VisualMerchandiser\Model\Resolver\QuantityAndStock implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Helper\Context $context, \Magento\Framework\EntityManager\MetadataPool $metadataPool)
    {
        $this->___init();
        parent::__construct($context, $metadataPool);
    }
