<?php
namespace Ced\ConnectBase\Model\ResourceModel\ProductLinking\Grid\Collection;

/**
 * Interceptor class for @see \Ced\ConnectBase\Model\ResourceModel\ProductLinking\Grid\Collection
 */
class Interceptor extends \Ced\ConnectBase\Model\ResourceModel\ProductLinking\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'ced_product_linking', $resourceModel = 'Ced\\ConnectBase\\Model\\ResourceModel\\ProductLinking', $identifierName = 'id')
    {
        $this->___init();
