<?php
namespace Ced\ConnectBase\Model\ResourceModel\Refund\Grid\Collection;

/**
 * Interceptor class for @see \Ced\ConnectBase\Model\ResourceModel\Refund\Grid\Collection
 */
class Interceptor extends \Ced\ConnectBase\Model\ResourceModel\Refund\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ced\ConnectBase\Service\Marketplace $marketplace, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'ced_return_refunds', $resourceModel = 'Ced\\ConnectBase\\Model\\ResourceModel\\Refund', $identifierName = 'id')
    {
        $this->___init();
        parent::__construct($marketplace, $entityFactory, $logger, $fetchStrategy, $eventManager, $mainTable, $resourceModel, $identifierName);
    }
