<?php
namespace Ced\ConnectBase\Model\ResourceModel\ActivityLog\Grid\ProductActivityDataProvider;

/**
 * Interceptor class for @see \Ced\ConnectBase\Model\ResourceModel\ActivityLog\Grid\ProductActivityDataProvider
 */
class Interceptor extends \Ced\ConnectBase\Model\ResourceModel\ActivityLog\Grid\ProductActivityDataProvider implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'ced_activities_log', $resourceModel = 'Ced\\ConnectBase\\Model\\ResourceModel\\ActivityLog', $identifierName = 'id')
    {
        $this->___init();
